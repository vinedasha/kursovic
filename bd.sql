ALTER TABLE deti_roditeli drop constraint fk_deti1;
ALTER TABLE deti_roditeli drop constraint fk_deti2;
ALTER TABLE deti_roditeli drop constraint fk_deti3;
ALTER TABLE family_obqed drop constraint fk_obqed;
ALTER TABLE rabota drop constraint fk_rabota;
ALTER TABLE family_obqed drop constraint fk_fam;
ALTER TABLE brack drop constraint fk_brack1;
ALTER TABLE brack drop constraint fk_brack2;
ALTER TABLE families drop constraint families_pkey;
ALTER TABLE rabota drop constraint rabota_pkey;
ALTER TABLE name_fam drop constraint name_fam_pkey;


DROP TABLE IF EXISTS families;
CREATE TABLE families(id_people int primary key NOT NULL, nme char(35), surname char(50), otch char(60), god_rogd int, pol char(10), eg_dohod int);
DROP TABLE IF EXISTS family_obqed;
CREATE TABLE family_obqed(id_people int NOT NULL, id_family int);
DROP TABLE IF EXISTS deti_roditeli;
CREATE TABLE deti_roditeli(id_rodit int NOT NULL, id_children int, id_bliznec int);
DROP TABLE IF EXISTS rabota;
CREATE TABLE rabota(id_people int primary key NOT NULL, firma char(50), adrec char(50), dolgnost char(20));
DROP TABLE IF EXISTS name_fam;
CREATE TABLE name_fam(id_family int primary key NOT NULL, name_family char(35));
DROP TABLE IF EXISTS brack;
